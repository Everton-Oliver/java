...
public class Exercicio03 {
	...
	public static void main(String[] args) {
		...
		EstoqueLoja produto1 = new EstoqueLoja("LEITOR BLURAY", (sorteia.nextInt(899999999) + 100000000), 20, 2499.00);
		EstoqueLoja produto2 = new EstoqueLoja("TV PANASONIC 4K", (sorteia.nextInt(899999999) + 100000000), 10, 2299.00);
		EstoqueLoja produto3 = new EstoqueLoja("PLACA DE VIDEO NVIDIA 9080", (sorteia.nextInt(899999999) + 100000000), 20, 4499.00);
		EstoqueLoja produto4 = new EstoqueLoja("APSTIRADOR DE PÓ", (sorteia.nextInt(899999999) + 100000000), 20, 899.00);
		EstoqueLoja produto5 = new EstoqueLoja("MAQUINA DE LAVAR ROUPA ELETROLUX", (sorteia.nextInt(899999999) + 100000000), 20, 799.00);
